...
public class NotificationAlertDrawer {
  ...
  private void init() {
    ...
    bellPath.cubicTo(-34.33f, 27.41f, -21.97f, 13.21f, -5.73f, 10.45f);
    bellPath.lineTo(-5.73f, 4.24f);
    bellPath.cubicTo(-5.73f, 1.06f, -3.15f, -1.51f, 0.01f, -1.51f);
    bellPath.close();
